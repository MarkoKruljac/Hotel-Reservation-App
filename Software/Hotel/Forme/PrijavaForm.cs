        ...
        private void SaljiEmail()
        {
            ...
            using ( var context = new PI20_021_DBEntities2())
            {
                ...
                var emailGostaUpit = from g in context.Gost
                                     ...
                                     where DateTime.Compare(r.Datum_pocetka, danasnjiDatum)==1 &&  r.ID_gosta == g.ID_gost && (g.PoslanEmail == false || g.PoslanEmail == null)
                                     select g;
                if(emailGostaUpit.FirstOrDefault() != null) { 
                    foreach (var item in emailGostaUpit)
                    {
                           ...
                           MailMessage mailDetails = new MailMessage();
                              ...
                              item.PoslanEmail = true;
                              

                    }
                    context.SaveChanges();
                    MessageBox.Show("Mail uspjesno poslan!");
                }
                else
                {
                    MessageBox.Show("Mailovi su vec poslani");
                }
            }
